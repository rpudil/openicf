...
public class XMLConfiguration extends AbstractConfiguration {
    ...
    private File xsdXsltFilePath = null;
    ...
    public void setXsdIcfFilePath(File xsdIcfFilePath) {
        this.xsdIcfFilePath = xsdIcfFilePath;
    }

    @ConfigurationProperty(displayMessageKey = "XSD_XSLT_FILEPATH_PROPERTY_DISPLAY", helpMessageKey = "XSD_XSLT_FILEPATH_PROPERTY_HELP")
    public File getXsltFilePath() {
        return this.xsdXsltFilePath;
    }

    public void setXsltFilePath(File xsdXsltFilePath) {
        this.xsdXsltFilePath = xsdXsltFilePath;
    }
